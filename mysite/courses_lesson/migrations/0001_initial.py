    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_name_ky', models.CharField(max_length=34, null=True)),
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses_lesson.teacher')),
            ],
        ),
        migrations.CreateModel(
            name='Exam',
